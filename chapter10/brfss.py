...
Downloaded from: https://github.com/rlabbe/ThinkBayes2/blob/master/code/brfss.py
Revised by Orlando, Ding, as relative path
"""
...
# add relative path for library of thinkbayes2 and thinkplot
import sys
...
#     for avoid saving to local disk of output pdf and eps files
